...
echo 10.0.31.111 > /sys/kernel/config/nvmet/ports/1/addr_traddr
...
echo 10.0.31.111 > /sys/kernel/config/nvmet/ports/2/addr_traddr
...
echo 10.0.31.111 > /sys/kernel/config/nvmet/ports/3/addr_traddr
...
echo 10.0.31.111 > /sys/kernel/config/nvmet/ports/4/addr_traddr
...
echo 10.0.31.111 > /sys/kernel/config/nvmet/ports/5/addr_traddr
...
echo 10.0.31.111 > /sys/kernel/config/nvmet/ports/6/addr_traddr
...
echo 10.0.31.111 > /sys/kernel/config/nvmet/ports/7/addr_traddr
...
echo 10.0.31.111 > /sys/kernel/config/nvmet/ports/8/addr_traddr
...
echo 10.0.31.111 > /sys/kernel/config/nvmet/ports/9/addr_traddr
...
echo 10.0.31.111 > /sys/kernel/config/nvmet/ports/10/addr_traddr
